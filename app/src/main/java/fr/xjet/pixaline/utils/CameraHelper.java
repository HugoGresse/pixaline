 ...
 *
 * From https://github.com/googlesamples/android-MediaRecorder/blob/master/Application/src/main/java/com/example/android/common/media/CameraHelper.java
 */
public class CameraHelper {
     ...
     * @return A file object pointing to the newly created file.
     */
    public static File getTempOutputMediaFile(Context context, int type){
        // To be safe, you should check that the SDCard is mounted
        // using Environment.getExternalStorageState() before doing this.
        if (!Environment.getExternalStorageState().equalsIgnoreCase(Environment.MEDIA_MOUNTED)) {
            return  null;
        ...
        try {
            return new File(context.getExternalCacheDir().getAbsolutePath(), timeStamp);
